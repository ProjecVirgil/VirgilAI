...
def main(language_choose:str):
    """Main function.

    Args:
        language_choose (str): _description_
    ...
    for i in range(5):
        try:
            with sr.Microphone() as source:
                ...
                command = listener.recognize_google(voice,language=language_choose)
                end_time = time.time()
...
if __name__ == "__main__":
    ...
    language_choose = str(input("Insert your language nation and dialet if is not dialet simple repeate the nation example it-it: "))
