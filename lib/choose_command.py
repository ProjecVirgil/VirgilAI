...
class CommandSelection:
    ...
    def __init__(self) -> None:
        ...
        self.stop_words_it = set(stopwords.words("italian")) #check lang
        ...
        self.temeperature= self.settings.temeperature
        self.max_token= self.settings.max_token
